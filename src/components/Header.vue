<template>
  <div
    ...
    class="bg-[#1C1E53] fixed w-full z-20 duration-200 md:px-[20px]"
  >
    <div class="container flex justify-between py-6 items-center">
      ...
      <div
        class="hidden md:flex items-center justify-between text-[#BBBBCB] gap-[52px]"
      >
        <router-link class="cursor-pointer hover:text-white" to="/"
          >Home</router-link
        >
        <router-link class="cursor-pointer hover:text-white" to="/about"
          >About us</router-link
        >
        <router-link class="cursor-pointer hover:text-white" to="/pricing"
          >Pricing</router-link
        >
        <router-link class="cursor-pointer hover:text-white" to="/work"
          >Work</router-link
        >
        <router-link class="cursor-pointer hover:text-white" to="/blog"
          >Blog</router-link
        >
        <router-link
          to="/contact"
          class="rounded-[41px] border-[2px] border-[#F4F6FC33] px-10 py-3 hover:bg-[#F4F6FC33] hover:text-white"
    ...
    <div v-if="menuOpen" class="md:hidden bg-[#1C1E53] text-[#BBBBCB] p-4">
      <router-link
        class="block py-2 px-4 hover:text-white"
        to="/"
        @click="closeMenu"
        >Home</router-link
      >
      ...
      >
      <button
        class="block w-full text-left rounded-[41px] border-[2px] border-[#F4F6FC33] px-4 py-3 mt-2 hover:bg-[#F4F6FC33] hover:text-white"
        @click="closeMenu"
      >
        Contact us
      </button>
