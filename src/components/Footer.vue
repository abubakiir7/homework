<template>
  <div class="bg-[#1C1E53]">
    <div class="container flex pt-14">
      <div class="w-2/4">
        <div class="w-8/12">
          <div class="cursor-pointer">
            ...
            >
              <g clip-path="url(#clip0_8208_208)">
                <path
              ...
              <defs>
                <clipPath id="clip0_8208_208">
                  <rect width="122" height="24.7089" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <h3 class="leading-[28px] text-[18px] font-medium text-white pt-5">
      ...
      <div class="w-[32%]">
        ...
        <p class="text-[18px] leading-[28px] text-[#F4F6FC] py-6">
