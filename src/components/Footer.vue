<template>
  <div class="bg-[#1C1E53]">
    <div
      class="container md:pt-14 md:flex-row flex flex-col items-center px-[8px] md:px-0"
    >
      <div class="md:w-2/4 w-full">
        <div class="md:w-8/12 w-full">
          <div class="cursor-pointer m-auto bg-red-300">
            <svg
              width="122"
              height="25"
              viewBox="0 0 122 25"
          ...
          <h3
            class="leading-[28px] text-[13px] md:text-[20px] md:text-left font-medium text-center text-white pt-5 w-[90%] m-auto md:m-0"
          >
      ...
      <div class="md:w-[32%]">
        <h2
          class="md:text-[48px] text-[20px] md:text-left text-center leading-[64px] text-white font-bold"
        >
          Lets Talk!
        </h2>
        <p
          class="md:text-[18px] text-[15px] text-center md:text-left leading-[28px] text-[#F4F6FC]"
        >
    ...
    <div class="container mt-2 md:pb-20">
      <div
        class="flex bg-[#FCD980] md:p-6 md:mr-[760px] md:p-0 md:py-0 p-[10px] py-[30px]"
      >
        <div class="mr-12">
